            ...
            <Paper className={classes.container} elevation={3}>
                ...
                <Holder>
                    <div className={classes.imageHolder} >
                        <Circle size="250px" style={{overflow: 'hidden'}}>
                            <FaUser style={{fontSize: '200px'}} />
                        </Circle>  
                    </div>
                    <TextContainer>
                        <TextWrapper>
                ...
                <ButtonContainer>
                    <Button color="primary" variant="contained" style={{backgroundColor: '#202950'}} onClick={handleClickOpen}>Update Password</Button>
                </ButtonContainer>              
            </Paper>
        </div>
