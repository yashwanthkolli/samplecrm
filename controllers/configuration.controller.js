...
exports.fetchRegistersList=(req,res)=>{
    ...
    fetch_registers = 'select regid, regname FROM railways.registers where oname=\'' +oname +'\' ;'   
...
exports.fetchRegistersLogs=(req,res)=>{
    const {oname, regid, scode}=req.body;
    fetch_logs = 'select * FROM railways.log where oname=\'' +oname +'\' and registerid=\'' + regid + '\' and scode=\'' + scode + '\' ;'   
